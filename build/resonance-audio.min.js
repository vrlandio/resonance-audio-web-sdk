 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(3),n=e(0);function s(A,t){void 0==t&&(t={}),void 0==t.ambisonicOrder&&(t.ambisonicOrder=n.DEFAULT_AMBISONIC_ORDER),void 0==t.azimuth&&(t.azimuth=n.DEFAULT_AZIMUTH),void 0==t.elevation&&(t.elevation=n.DEFAULT_ELEVATION),void 0==t.sourceWidth&&(t.sourceWidth=n.DEFAULT_SOURCE_WIDTH),this._context=A,this.input=A.createGain(),this._channelGain=[],this._merger=void 0,this.output=A.createGain(),this.setAmbisonicOrder(t.ambisonicOrder),this._azimuth=t.azimuth,this._elevation=t.elevation,this.setSourceWidth(t.sourceWidth)}s.prototype.setAmbisonicOrder=function(A){this._ambisonicOrder=s.validateAmbisonicOrder(A),this.input.disconnect();for(let e=0;e<this._channelGain.length;e++)this._channelGain[e].disconnect();void 0!=this._merger&&this._merger.disconnect(),delete this._channelGain,delete this._merger;let t=(this._ambisonicOrder+1)*(this._ambisonicOrder+1);this._merger=this._context.createChannelMerger(t),this._channelGain=new Array(t);for(let e=0;e<t;e++)this._channelGain[e]=this._context.createGain(),this.input.connect(this._channelGain[e]),this._channelGain[e].connect(this._merger,0,e);this._merger.connect(this.output)},s.prototype.setDirection=function(A,t){(void 0==A||isNaN(A))&&(A=n.DEFAULT_AZIMUTH),(void 0==t||isNaN(t))&&(t=n.DEFAULT_ELEVATION),this._azimuth=A,this._elevation=t,(A=Math.round(A%360))<0&&(A+=360),t=Math.round(Math.min(90,Math.max(-90,t)))+90,this._channelGain[0].gain.value=i.MAX_RE_WEIGHTS[this._spreadIndex][0];for(let e=1;e<=this._ambisonicOrder;e++){let n=i.MAX_RE_WEIGHTS[this._spreadIndex][e];for(let s=-e;s<=e;s++){let o=e*e+e+s,r=e*(e+1)/2+Math.abs(s)-1,a=i.SPHERICAL_HARMONICS[1][t][r];if(0!=s){let t=i.SPHERICAL_HARMONICS_MAX_ORDER+s-1;s<0&&(t=i.SPHERICAL_HARMONICS_MAX_ORDER+s),a*=i.SPHERICAL_HARMONICS[0][A][t]}this._channelGain[o].gain.value=a*n}}},s.prototype.setSourceWidth=function(A){this._spreadIndex=Math.min(359,Math.max(0,Math.round(A))),this.setDirection(this._azimuth,this._elevation)},s.validateAmbisonicOrder=function(A){return isNaN(A)||void 0==A?(n.log("Error: Invalid ambisonic order",options.ambisonicOrder,"\nUsing ambisonicOrder=1 instead."),A=1):A<1?(n.log("Error: Unable to render ambisonic order",options.ambisonicOrder,"(Min order is 1)","\nUsing min order instead."),A=1):A>i.SPHERICAL_HARMONICS_MAX_ORDER&&(n.log("Error: Unable to render ambisonic order",options.ambisonicOrder,"(Max order is",i.SPHERICAL_HARMONICS_MAX_ORDER,")\nUsing max order instead."),options.ambisonicOrder=i.SPHERICAL_HARMONICS_MAX_ORDER),A},A.exports=s},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const i=e(0);function n(A,t){void 0==t&&(t={}),void 0==t.alpha&&(t.alpha=i.DEFAULT_DIRECTIVITY_ALPHA),void 0==t.sharpness&&(t.sharpness=i.DEFAULT_DIRECTIVITY_SHARPNESS),this._context=A,this._lowpass=A.createBiquadFilter(),this._lowpass.type="lowpass",this._lowpass.Q.value=0,this._lowpass.frequency.value=.5*A.sampleRate,this._cosTheta=0,this.setPattern(t.alpha,t.sharpness),this.input=this._lowpass,this.output=this._lowpass}n.prototype.computeAngle=function(A,t){let e=i.normalizeVector(A),n=i.normalizeVector(t),s=1;if(this._alpha>i.EPSILON_FLOAT){let A=e[0]*n[0]+e[1]*n[1]+e[2]*n[2];s=1-this._alpha+this._alpha*A,s=Math.pow(Math.abs(s),this._sharpness)}this._lowpass.frequency.value=.5*this._context.sampleRate*s},n.prototype.setPattern=function(A,t){this._alpha=Math.min(1,Math.max(0,A)),this._sharpness=Math.max(1,t),this.computeAngle([this._cosTheta*this._cosTheta,0,0],[1,0,0])},A.exports=n},function(A,t,e){"use strict";
/**
 * @license
 * Copyright 2017 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
